...
export function PageFrame() {
  return (
    <>
      {/* Top horizontal band - full width */}
      <div
        aria-hidden="true"
        className="fixed top-0 left-0 right-0 h-10 lg:h-14 z-20 bg-repeat-x bg-center pointer-events-none"
        style={{
      ...
      {/* Bottom horizontal band - full width */}
      <div
        aria-hidden="true"
      ...
      {/* Left vertical column - tucked between top and bottom bands */}
      <div
        aria-hidden="true"
        className="fixed left-0 top-10 bottom-10 lg:top-14 lg:bottom-14 w-10 lg:w-14 z-20 bg-repeat-y bg-center pointer-events-none hidden md:block"
        style={{
      ...
      <div
        aria-hidden="true"
        className="fixed right-0 top-10 bottom-10 lg:top-14 lg:bottom-14 w-10 lg:w-14 z-20 bg-repeat-y bg-center pointer-events-none hidden md:block"
        style={{
          backgroundImage: "url('/ornaments/zellige-column.jpg')",
          backgroundSize: "100% auto",
        }}
